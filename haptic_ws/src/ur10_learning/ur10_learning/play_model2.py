...
class UR10(Node):
    ...
    def play_model(self):
        ...
        p2 = [-0.3,1.0,1.36]
        p3 = [-0.3, 0.5,1.36]
        s = list(self.joint_positions) +list(self.tool_translation) +p1 + p2 + p3
...
def main(args=None):
    ...
    folderpath = '~/ros_projects/haptic_ws/src/ur10_learning/data/demonstrations/'+ folder_name +'/DAgger_model2/'
    ...
    print("[*] Press A to play model")
    print("[*] Press B to stop model")
    try:
